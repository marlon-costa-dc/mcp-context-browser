...
//!
//! Configuration struct for HTTP client settings used by API-based providers.
...
/// Sensible defaults are provided based on provider constants.
///
/// # Example
///
/// ```rust
/// use mcb_providers::http::HttpClientConfig;
/// use std::time::Duration;
///
/// // Use defaults
...
///
/// // Custom timeout
/// let config = HttpClientConfig::with_timeout(Duration::from_secs(60));
/// ```
