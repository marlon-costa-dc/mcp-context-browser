...
use super::engine::HybridSearchEngine;
...
pub enum HybridSearchMessage {
    ...
    Search {
        ...
        semantic_results: Vec<mcb_domain::value_objects::SearchResult>,
...
/// Spawn a hybrid search actor and return its sender
pub fn spawn_hybrid_search_actor(
    bm25_weight: f32,
    semantic_weight: f32,
) -> mpsc::Sender<HybridSearchMessage> {
