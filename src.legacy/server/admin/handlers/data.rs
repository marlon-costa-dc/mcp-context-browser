...
pub async fn create_backup_handler(
    ...
    Json(backup_config): Json<crate::server::admin::service::BackupConfig>,
) -> Result<Json<ApiResponse<crate::server::admin::service::BackupResult>>, StatusCode> {
    let result = state
        .admin_service
...
pub async fn list_backups_handler(
    State(state): State<AdminState>,
) -> Result<Json<ApiResponse<Vec<crate::server::admin::service::BackupInfo>>>, StatusCode> {
...
) -> Result<Json<ApiResponse<crate::server::admin::service::RestoreResult>>, StatusCode> {
    let result = state
        .admin_service
