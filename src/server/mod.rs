...
use crate::core::cache::{init_global_cache_manager, CacheManager};
...
impl McpServer {
    ...
    async fn get_indexing_status(
        ...
        let mut message = format!("📊 **MCP Context Browser - System Status**\n\n");
        ...
        message.push_str(&format!("🏥 **Service Health**\n"));
        ...
        message.push_str(&format!("⚡ **Performance Metrics**\n"));
        ...
        message.push_str(&format!("🔧 **Available Operations**\n"));
        ...
        message.push_str(&format!("💡 **Usage Recommendations**\n"));
        ...
        // Architecture notes
        message.push_str(&format!("🏗️ **Architecture Features**\n"));
    ...
    async fn clear_index(
        ...
        let mut message = format!("🗑️ **Index Clearing Operation**\n\n");
