//! Resource limits enforcer implementation
//!
//! Implements resource monitoring and limits to prevent system overload.

use crate::domain::error::{Error, Result};
use crate::infrastructure::limits::config::ResourceLimitsConfig;
...
pub struct OperationCounters {
    pub active_indexing: AtomicUsize,
    pub active_search: AtomicUsize,
    pub active_embedding: AtomicUsize,
    /// Tracks operations waiting to acquire permits
    pub queued_indexing: AtomicUsize,
    pub queued_search: AtomicUsize,
    pub queued_embedding: AtomicUsize,
}
